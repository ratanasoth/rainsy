...
<div class="row">
    <div class="col-sm-12">
        <form class="form-horizontal" action="<?php echo base_url('logo/doupload'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo base_url('logo'); ?>" class="btn btn-sm btn-success">Back</a>
                </div>
            </div>
            <div class="form-group">
